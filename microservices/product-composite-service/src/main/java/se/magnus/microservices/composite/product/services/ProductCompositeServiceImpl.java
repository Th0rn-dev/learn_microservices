...
public class ProductCompositeServiceImpl implements ProductCompositeService {
    ...
    private ProductAggregate createProductAggregate(
        ...
        List<ReviewSummary> reviewSummaries = Objects.isNull(reviews)
                ? null
                : reviews.stream()
        ...
        String reviewAddress = (!Objects.isNull(reviews) && reviews.size() > 0)
                ? reviews.get(0).getServiceAddress()
                : "";
        String recommendationAddress = (!Objects.isNull(recommendations) && recommendations.size() > 0)
